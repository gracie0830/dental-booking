...
session_start();
	...
	if(!$_SESSION['login_btn']){
		...
		if(isset($_POST['book_btn']))
		{
			...
			if ($today < $bookdate)
			{
				$sql = "INSERT INTO `appointments`(reservationDateTime, schedDate, schedTime, service, status) VALUES
				('$dttoday', '$bookdate', '$booktime', '$services', '')";
...
?>
	...
	<a href="appointment.php" class="back_btn">Back >></a>
